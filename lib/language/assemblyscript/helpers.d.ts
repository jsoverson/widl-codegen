...
export declare function defaultValueForType(type: Type): string;
/**
 ...
 * @param isReference if the type that is being expanded has a `@ref` annotation
 */
export declare const expandType: (type: Type, useOptional: boolean, isReference: boolean) => string;
/**
 ...
 * @param isReference if the type that is being expanded has a `@ref` annotation
 */
export declare function read(variable: string, t: Type, prevOptional: boolean, isReference: boolean): string;
/**
 ...
 */
export declare function mapArgs(args: InputValueDefinition[]): string;
export declare function mapArg(arg: InputValueDefinition): string;
/**
