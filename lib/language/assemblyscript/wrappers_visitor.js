...
class WrappersVisitor extends widl_1.BaseVisitor {
    ...
    visitOperation(context) {
        ...
        this.write(`function ${operation.name.value}Wrapper(payload: ArrayBuffer): ArrayBuffer {\n`);
      ...
      inputArgs.decode(decoder);\n`);
        ...
        if (_1.isVoid(operation.type)) {
            ...
            this.write(_1.size("response", operation.type, _1.isReference(operation.annotations)));
    ...
    visitWrapperBeforeInvoke(context) {
