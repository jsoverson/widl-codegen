...
export declare function functionName(str: string): string;
 ...
 */
export declare function mapArgs(args: InputValueDefinition[], template?: boolean): string;
export declare function mapArg(arg: InputValueDefinition, template?: boolean): string;
/**
