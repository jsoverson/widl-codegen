...
class Context {
    ...
    clone({ object, operations, operation, argumentsDef, argument, argumentIndex, fields, field, fieldIndex, enumDef, enumValues, enumValue, union, input, annotations, annotation, }) {
